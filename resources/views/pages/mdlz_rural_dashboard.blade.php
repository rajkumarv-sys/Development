...
var active_layer,initiated_layer,activated_layer,inactive_layer,deactivated_layer,recomand_subrd_layer,exist_subrd_layer,whole_subrd_layer,urban_subrd_layer,villg_distributor_layer,villg_subd_layer,circle_distributor_layer,circle_subd_layer;
    ...
    var gl = L.mapboxGL({
        attribution: "",
        //style: 'https://api.maptiler.com/maps/b050c133-75f8-4bc7-88cc-0a33b76a8993/style.json?key=9rAm7DYklXW1GiEDhdG0'
    ...
    var filer_clear = L.easyButton({
        ...
        states: [{
            ...
            onClick: function(control) {
               ...
               // showboundbyusertype('');
                // $('#maphead').html('');
                $("#maphead h3").html('<div class="center-maphead">  <div class="text-maphead">'+res['head']+'</div> <div class="text-tooltip-maphead">'+res['head']+'</div></div>');
                legendremove();
                removelayer();
                $("#showdata").css("display", "none");
            }
...
if(retailer && res['result']['highway_retailer']!=undefined && res['result']['highway_retailer']!=null)
  {
   ...
   function getColor(maxvalue, minvalue, delta,low,high) {
    ...
    {
        result.info='';
          if(result.subrd_type!=0 && result.is_hub==1)
          {
              shareinfo='';
              result.info='<div class="container-fluid p-3 popupbox" style="z-index: 1000;height:fit-content;color:white !important;"><span class="d-flex flex-row justify-content-between"><h5 style="padding-top:0.3rem;">'+result.location_name+' &nbsp;</h5><div class="d-flex flex-row" style="height:max-content;margin-right: -0.7rem;"><img class="ml-1" style="cursor:pointer;" src="icons/share-icon.png" height="30px" onclick="share(\''+shareinfo+'\',this)"  lat="'+result.latitude+'" lon="'+result.longitude+'" id="share_'+result.village_census+'"><img class="ml-1" style="cursor:pointer;" geocode="'+result.latitude+','+result.longitude+'" onclick="location_navigate(this)" src="icons/navigation-icon.png" height="30px"><span class="popup" style="background: transparent;"><img class="ml-1" style="cursor:pointer;" id="'+result.village_census+'" src="icons/close-icon.png" height="30px" onClick="closeicon(this)"></span></div></span><h5><span class="badge font-italic" style="text-align: left;background-color:#424242;"><span style="line-height:1rem;">'+result.taluk_name+' Sub-Distt</span><br><span style="line-height:1rem;">'+result.district_name+'  Distt</span></span></h5><hr style="border-top: 1px solid white;"><p><span style="color:#1ae3b1;font-weight:bold;text-decoration:underline;">Recommendation:</span> '+result.cluster_type+'</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Distance from '+result.cluster_hub+' (km): </span>0 kms</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Population (2021): </span>'+result.population+' </p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">FMCG Retlr Univ Nos.: </span>'+result.retlr_universe+' Nos.</p>';

              if(result.subrd_type==1)
                result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">MDLZ Cvrg Nos: </span>'+result.mdlz_retlr_universe+' Nos.</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Villg. Choc Consumption (Annual) (Rs.): </span>'+result.village_choc_consmptn+' </p>';
           
            rural_img=(result.rpi_img == '') ? '' : '<img src="rural_icon/'+result.rpi_img+'.jpg"></img>';
            result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">Rural Progressive Index: </span><span >'+rural_img+'</span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Cluster Tag: </span>'+result.cluster_tag+' </p>';
            if($.inArray(result.subrd_type,[2,3]) != -1)
             result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">SubRD Priority: </span> '+result.subrd_priority+'</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">SubRD Cluster Priority: </span>'+result.subrd_priority+'</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Market UID: </span><span style="background-color:white;color:black;">'+result.market_id+'</span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">BI Location ID: </span><span style="background-color:white;color:black;" >'+result.bi_id+' </span></p>';
             if(result.subrd_type==1)
                result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">Exist SubRD Code: </span><span style="background-color:white;color:black;" >'+result.exist_subrd_code+' </span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Exist SubRD Name: </span><span style="background-color:white;color:black;" >'+result.exist_subrd_name+' </span></p>';
             result.info +='<div class="popup-footer" ><span style="background-color:none;text-align:right;cursor:pointer;" class="navigate_location" onclick="view_village_detail()">More Info</span></div></div>';

          }
          else if(result.subrd_type!=0 && result.is_hub!=1)
          {
            shareinfo='';
             result.info='<div class="container-fluid p-3 popupbox" style="z-index: 1000;height:fit-content;color:white !important;"><span class="d-flex flex-row justify-content-between"><h5 style="padding-top:0.3rem;">'+result.location_name+' &nbsp;</h5><div class="d-flex flex-row" style="height:max-content;margin-right: -0.7rem;"><img class="ml-1" style="cursor:pointer;" src="icons/share-icon.png" height="30px" onclick="share(\''+shareinfo+'\',this)"  lat="'+result.latitude+'" lon="'+result.longitude+'" id="share_'+result.village_census+'"><img class="ml-1" style="cursor:pointer;" geocode="'+result.latitude+','+result.longitude+'" onclick="location_navigate(this)" src="icons/navigation-icon.png" height="30px"><span class="popup" style="background: transparent;"><img class="ml-1" style="cursor:pointer;" id="'+result.village_census+'" src="icons/close-icon.png" height="30px" onClick="closeicon(this)"></span></div></span><h5><span class="badge font-italic" style="text-align: left;background-color:#424242;"><span style="line-height:1rem;">'+result.taluk_name+' Sub-Distt</span><br><span style="line-height:1rem;">'+result.district_name+'  Distt</span></span></h5><hr style="border-top: 1px solid white;"><p><span style="color:#1ae3b1;font-weight:bold;text-decoration:underline;">Recommendation:</span> '+result.cluster_type+'</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Distance from '+result.cluster_hub+' (km): </span>0 kms</p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Population (2021): </span>'+result.population+' </p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">FMCG Retlr Univ Nos.: </span>'+result.retlr_universe+' Nos.</p>';
            if(result.subrd_type==1)
                result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">MDLZ Cvrg Nos: </span>'+result.mdlz_retlr_universe+' Nos.</p>';
            rural_img=(result.rpi_img == '') ? '' : '<img src="rural_icon/'+result.rpi_img+'.jpg"></img>';
            result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">Rural Progressive Index: </span><span >'+rural_img+'</span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Cluster Tag: </span>'+result.cluster_tag+' </p>';
          ...
          else if(result.subrd_type==0)
          {
            shareinfo='';
             result.info='<div class="container-fluid p-3 popupbox" style="z-index: 1000;height:fit-content;color:white !important;"><span class="d-flex flex-row justify-content-between"><h5 style="padding-top:0.3rem;">'+result.location_name+' &nbsp;</h5><div class="d-flex flex-row" style="height:max-content;margin-right: -0.7rem;"><img class="ml-1" style="cursor:pointer;" src="icons/share-icon.png" height="30px" onclick="share(\''+shareinfo+'\',this)"  lat="'+result.latitude+'" lon="'+result.longitude+'" id="share_'+result.village_census+'"><img class="ml-1" style="cursor:pointer;" geocode="'+result.latitude+','+result.longitude+'" onclick="location_navigate(this)" src="icons/navigation-icon.png" height="30px"><span class="popup" style="background: transparent;"><img class="ml-1" style="cursor:pointer;" id="'+result.village_census+'" src="icons/close-icon.png" height="30px" onClick="closeicon(this)"></span></div></span><h5><span class="badge font-italic" style="text-align: left;background-color:#424242;"><span style="line-height:1rem;">'+result.taluk_name+' Sub-Distt</span><br><span style="line-height:1rem;">'+result.district_name+'  Distt</span></span></h5><hr style="border-top: 1px solid white;"><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Population (2021): </span>'+result.population+' </p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">FMCG Retlr Univ Nos.: </span>'+result.retlr_universe+' Nos.</p>';
                  rural_img=(result.rpi_img == '') ? '' : '<img src="rural_icon/'+result.rpi_img+'.jpg"></img>';
                result.info +='<p><span style="color:rgb(242, 101, 34);font-weight:bold;">Rural Progressive Index: </span><span>'+result.rural_img+'</span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">Market UID: </span><span style="background-color:white;color:black;">'+result.market_id+'</span></p><p><span style="color:rgb(242, 101, 34);font-weight:bold;">BI Location ID: </span><span style="background-color:white;color:black;" >'+result.bi_id+' </span></p>';
                result.info +='<div class="popup-footer" ><span style="background-color:none;text-align:right;cursor:pointer;" class="navigate_location" onclick="view_village_detail()">More Info</span></div></div>';  
    ...
    function changestyle_byresult(layer, result) {
      ...
      if (result.hasOwnProperty('hub_id'))
      {
         result.info= getInfo(result);
      }
...
function share(info,data)
{
   ...
   function tablebuild(res, type) {
        ...
        if ($.fn.dataTable.isDataTable('#griddata')) {
            ...
            if (type == 4 || type==5 || type==6 || type==7 || type==8 || type==9 || type==10 || type==11  || type==13 || type==14 || type==15 || type==16 || type==17 || type==19 || type==20 || type==21) {
            ...
            if (type == 4 || type==5 || type==6 || type==7 || type==8 || type==9 || type==10 || type==11 || type==12 || type==13 || type==14 || type==15 || type==16 || type==17 || type==19 || type==20 || type==21) {
            	    ...
            	    if(data[0]['show_summary']!=undefined && data[0]['show_summary']!=null &&  data[0]['show_summary']!=0)
                     {
                         var div = L.DomUtil.create('div', 'info2 legend2');
                          div.innerHTML ='';
                         // div.innerHTML='<div id="div-to-toggle"><button onclick="myFunction()" class="btn-close" > <img src="assets/images/info-icon.png" alt="" width="20" height="20"></button><div id="myDIV"><div id="round-legend"></div>';
                    ...
                    if(data[0]['Distributor'] ==undefined && data[0]['Distributor']==null)
                     {
                          ...
                          if(data[0][1] !=0)
                             texttml +='<div class="legend-wraper2" dir="rtl" >Most Develpd Villgs: '+data[0][1]+'</div>';
                          if(data[0][2] !=0)
                             texttml +='<div class="legend-wraper2" dir="rtl" >Develpd Villgs: '+data[0][2]+'</div>';
