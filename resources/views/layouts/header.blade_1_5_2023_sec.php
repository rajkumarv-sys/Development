    ...
    <nav class="navbar navbar-inverse navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="menu-nav" id="header-mainmenu">
                ...
                <ul class="nav">
                <li class="nav-item pt-2" style="background: white;text-align: center;min-height:7rem;">
                	@php
					...
					{
					@endphp
                    <img src="{{ url('/storage/Rural-Expansion-Tool-Logo.png') }}" alt="" style="width:80%;padding:5px 0;">
                    @php
                    }
                    @endphp
...
@endphp
                    ...
                    <div class="dropdown-divider"></div>
                    <li class="nav-item" style="color:#fff;cursor: pointer;">
                        <a class="nav-link show_case_result" id="12" type="1,2" href="#">Sub Recommendation</a>
                    </li>
                     <li class="nav-item" style="color:#fff;cursor: pointer;">
