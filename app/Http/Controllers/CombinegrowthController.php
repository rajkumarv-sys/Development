...
class CombinegrowthController extends Controller
{
    private $low=[5,69,54];
    ...
    public function Combinegrowth($result,$detailed_result,$additional_result,$suffix_of_result)
    {
    ...
    $chart_data=[];$chartdata_series=[];
        ...
        $inr=0;
          ...
          {       
              ...
              {
                array_push($temp['data'],['y'=>(float)$processed_result[$j]['result'],'color'=>$processed_result[$j]['color']]);
