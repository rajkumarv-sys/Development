    ...
    public function getHighway(Request $request)
    {
        ...
        if($request->has('filter'))
             {
                ...
                $qHighway->where('highway_outlet.channel',$request->get('filter'));
                // if($filter['filterType']=='subrd_code')
                //       $qHighway->where('c.subrd_code',$filter['subrd_code']);
        ...
        if($request->has('highway_id')) {
          foreach($aHighWayInputs as $iHighway){
            ...
            $loadmap ="https://analytics.brandidea.com/mapshapes/highway_path/" . str_replace(' ','',$sHWName) .".geojson";
        ...
        $highway['legend'] = array(
            ['name' => 'Actual SubRD', 'value' => 'https://analytics.brandidea.com/bilocaview/public/highway/actual_subrd.png'],
            ['name' => 'Recommended SubRD', 'value' => 'https://analytics.brandidea.com/bilocaview/public/highway/recomnd_subrd.png'],
            ['name' => 'Group A', 'value' => 'https://analytics.brandidea.com/bilocaview/public/highway/group_a_retailer.png'],
            ['name' => 'Group B', 'value' => 'https://analytics.brandidea.com/bilocaview/public/highway/group_b_retailer.png']
        );
